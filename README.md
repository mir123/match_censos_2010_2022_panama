# Amansando los datos del censo de Panamá de 2022

Salieron los datos del censo de 2022 en Panamá, pero tienen problemas. 
...
CASE WHEN
	...
	ELSE 'cambio'
END AS cambio,
panama_censo_2020_hogares_personas.hogares as hogares_2020,
panama_censo_2020_hogares_personas.personas as personas_2020,
...
nombre_2010,
personas_2010,
panama_censo_2020_hogares_personas.codigo_9 AS codigo_2020, 
panama_censo_2020_hogares_personas.nombre AS nombre_2020, 
correg_2020, 
substring(correg_2020 for 2) AS provincia, 
substring(correg_2020 from 3 for 2) AS distrito, 
panama_censo_2020_hogares_personas.hogares as hogares_2020,
panama_censo_2020_hogares_personas.personas as personas_2020,
lugpob_corregimientos_actualizados_2020.geom
...
los_que_cambiaron_tabla_2 WHERE codigo_2020 IS NOT NULL
UNION ALL
SELECT los_mal_calificados_tabla.* , 'pase_4' AS cambio FROM 
los_mal_calificados_tabla WHERE codigo_2020 IS NOT NULL
UNION ALL
SELECT los_mal_calificados_tabla2.* , 'pase_5' AS cambio FROM 
los_mal_calificados_tabla2 WHERE codigo_2020 IS NOT NULL
UNION ALL
SELECT los_que_cambiaron_tabla_3.* , 'pase_6' AS cambio FROM 
los_que_cambiaron_tabla_3 WHERE codigo_2020 IS NOT NULL
UNION ALL
SELECT los_que_cambiaron_tabla_4.* , 'pase_7' AS cambio FROM 
los_que_cambiaron_tabla_4 WHERE codigo_2020 IS NOT NULL
UNION ALL
...
'' AS codigo_2020,
'' AS nombre_2020,
lugpob_corregimientos_actualizados_2020.correg_2020,
'' AS provincia,
'' AS distrito,
NULL AS hogares_2020,
NULL AS personas_2020,
lp.geom,
...
codigo_9 AS codigo_2020,
nombre AS nombre_2020,
substring(codigo_9 for 6) AS correg_2020,
provincia AS provincia,
distrito AS distrito,
hogares AS hogares_2020,
personas AS personas_2020,
...
'no encaja 2020' AS cambio
FROM panama_censo_2020_hogares_personas
